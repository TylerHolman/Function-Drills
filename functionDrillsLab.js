...
const jsNinja = () => console.log(`I am a JavaScript ninja!`) //no need for curly brackets with arrow functions.
...
function greeting(name){
  console.log(`Hello ` + name)//QUESTION FOR QUEUE
}
...
let nameGreeting = nameCheck(`Tyler`)
...
function printAllNames(listNames){      //listNames is place holder for the array 
...
console.log(bestMovie(`LOTR Return of the King`))
...
function stringsSample(str){
  console.log(str.toUpperCase())
}
stringsSample(sampleString)
...
console.log(emailCheck(`                    jimmyjohnspizza@gmail.com                    `))
////////////////// PROBLEM 19 ////////////////////
/*
...
function goldpouch(gold){
  let frogcounter = 0
  while (gold >= 3){
    frogcounter++
    gold -= 3
    console.log(`${gold} left.`)
    console.log(`Total chocolate frogs ${frogcounter}.`)
  }
   return frogcounter 
}
//let totalFrogs = goldpouch(80)
